...
US 1.1: CSV/XLSX-Import
  ...
  Tasks:
    - [ ] Upload- und Parser-Integration
    - [ ] Fehlerhandling & User-Feedback
...
US 3.1: Tabellenansicht mit Editieren, Filtern, Suchen
  ...
  Tasks:
    - [ ] Tabellen-UI & Editierfunktion
    - [ ] Filter/Dropdowns pro Spalte
    - [ ] Suchfeld global
